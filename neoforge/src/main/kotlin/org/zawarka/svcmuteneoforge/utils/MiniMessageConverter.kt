...
fun Component.toVanilla(server: MinecraftServer = SvcMuteNeoforge.server!!): net.minecraft.network.chat.Component {
...
fun Component.string() : String {
    return MiniMessageConverter.toString(this)
}
...
object MiniMessageConverter {
    ...
    fun toString(text: Component): String {
